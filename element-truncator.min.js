...
d.css({display:m});a.css({height:e(c.last())});d.css({opacity:1})},g=function(b){if(b.target==this)switch(a.data("collapsed")){case !0:d.css({display:"none"});a.css({height:"auto"});a.trigger("afterCollapse");break;case !1:a.css({height:"auto"}),a.trigger("afterExpand")}};a.css({transition:"height "+b.animation_duration+"ms"});d.css({opacity:0});c.css({transition:"opacity "+b.animation_duration+"ms"});a.on("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend",g)}else k=
